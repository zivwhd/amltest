...
class Task:
    def __init__(self, dataset_name: str, dataset_test: str, dataset_column_text: str, dataset_column_label: str,
                 bert_fine_tuned_model: str, roberta_fine_tuned_model: str, distilbert_fine_tuned_model: str,
                 llama_model: str, mistral_model: str, is_finetuned_with_lora: bool,
                 labels_str_int_maps: Union[Dict, None], test_sample: Union[int, None], name: str, paper_name: str,
                 llm_task_prompt: str, llm_few_shots_prompt: List[Tuple[str, str]], is_llm_set_max_len = False,
                 llama_adapter: str = None, mistral_adapter: str = None, llm_explained_tokenizer_max_length: int = 0,
                 task_definition: str = ""):
